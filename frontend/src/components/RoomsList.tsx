    ...
    <section className='py-16 min-h-[90vh]'>
        ...
        <div className='flex flex-col items-center'>
            ...
            <div className='relative w-[82px] h-[20px]'>
                <Image alt='' src='/assets/heading-icon.svg' fill className='object-cover'/>
            </div>
         ...
         {/* tabs */}
         <div>
            <Tabs defaultValue='all' className='w-[240px] h-[200px] lg:w-[540px] lg:h-auto mb-8 mx-auto'>
            ...
            return (
                <div key={room.id}>
                    <Link href={`/room/${room.id}`}>
                        <div className='w-full h-[300px] overflow-hidden mb-6 relative'>
                    ...
                    <div className='h-[134px]'>
                        ...
                        <div>
                            ...
                            <p className='h3 font-secondry font-medium text-accent mb-4'>${room.attributes.price} <span className='text-base text-secondary'>/ night</span></p>
                        </div>
                    </div>
                </div>
            )
