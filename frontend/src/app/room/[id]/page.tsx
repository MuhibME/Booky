        ...
        <div className='flex flex-col lg:flex-row lg:gap-12 h-full'>
          ...
          <div className='flex-1'>
            ...
            <div className='flex justify-between items-center mb-4'>
              ...
              <p className='h3 font-secondry font-medium text-accent'>${room.data.attributes.price} <span className='text-base text-secondary'>/night</span></p>
            </div>
            <div>
              {/* info */}
              <div className='items-center gap-8 flex mb-4'>
